        ...
        <div className="w-full max-w-lg">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              >
                <img src={img} alt={title} className="w-28 h-28 object-contain mb-3" draggable={false} />
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="password" name="password" value={base.password} onChange={handleBase} className="input" placeholder="Mín. 6 caracteres" required />
                </div>
                <div>
                  <label className="label">Repetir *</label>
                  <input type="password" name="password2" value={base.password2} onChange={handleBase} className="input" placeholder="••••••" required />
                </div>
              </div>
            </div>
